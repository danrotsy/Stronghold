...
// replicates CameraServer486.cpp in java lib

public class CameraServer486 {
  ...
  private boolean imageQueued = false;
  private Image savedImage;
  private static CameraServer486 server;
  
  public static CameraServer486 getInstance() {
    if (server == null) {
      server = new CameraServer486();
    }
    return server;
  }
  ...
  private CameraServer486() {
    ...
    serverThread.setName("CameraServer486 Send Thread");
    serverThread.start();
  }
  ...
  public void saveImage() {
      String fileName = "C:/Users/486/Desktop/temp.txt";
      ...
      try {
          ...
          bufferedWriter.write(savedImage.getClass().getName());
